...
<table class="table-bordered" border="1" cellpadding="5" cellspacing="0" style="width: 100%; border: 2px solid #1450A3;">
        ...
        <div class="container" style="padding-top: 10px; padding-bottom: 50px; margin-left: 0px;">
            <td></td>
            <button class="btn btn-success"><a href="tambah_foto2.php" style="color: white; text-decoration: none;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-plus-circle" viewBox="0 0 16 16">
